...
import org.kesler.common.WelcomeMessage;
...
public class WelcomeRestService {
     ...
     * repository is loaded from an ApplicationContext (see the SimpleRestAppFactory).
     */
    @Autowired
     ...
     * <p/>
     * By default the URL will point to 'http://localhost:8080/PVDConnect-server' which should hit your
    ...
    /**
     * Constructs a new instance of this repository so that it will provide access to the REST methods made available by
     ...
     *                  'http://localhost:8080/PVDConnect-server'
     */
