...
public class WelcomeController {
    ...
    /**
     * This method is exposed as a REST repository. The @RequestMapping parameter tells Spring that when a request comes in
     * to the server at the sub-url of '/welcome' (e.g. http://localhost:8080/PVDConnect-server/welcome)
